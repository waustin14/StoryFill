...
JWT_SECRET = env("JWT_SECRET", "storyfill-dev-secret-do-not-use-in-production")
...
POLISH_ENABLED = env("POLISH_ENABLED", "true").lower() in ("true", "1", "yes")
POLISH_MODEL = env("POLISH_MODEL", "gpt-4.1-nano")
POLISH_TIMEOUT = int(env("POLISH_TIMEOUT", "10"))
